...
sed -i "s/till_number_forrepl/$1/" ./bashedscript.ps1
echo -e "\n Running script on $1...\n"
echo " -----------------------------"
profuse task run run-script-posserver $(echo $1 | cut -c 1-6)s001 "/root/scripts/fadeless/bashedscript.ps1" > $1_log
